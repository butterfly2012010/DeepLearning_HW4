...
This homework mainly refers to two GItHub repository,
1. [aladdinpersson/Machine-Learning-Collection](https://github.com/Bakikii/aladdinpersson-Machine-Learning-Collection/tree/master/ML/Pytorch/object_detection/YOLOv3)
2. [deepeshdm/Object_Detection_YOLOV3](https://github.com/deepeshdm/Object_Detection_YOLOV3)

and also the ChatGPT. I use it to help me generate the segmentation head and other details.
...
----------------------------------------------------------------
        Layer (type)               Output Shape         Param #
================================================================
            Conv2d-1            [-1, 3, 416, 416]
            Relu-1            [-1, 256, 416, 416]
            DCN-Conv2d-1      [-1, 256, 416, 416]
            Relu-2            [-1, 256, 416, 416]
            Conv2d-2          [-1, 256, 416, 416]
            Relu-3            [-1, 256, 416, 416]
            Conv2d-3          [-1, 256, 416, 416]
            Relu-4            [-1, 256, 416, 416]
            Conv2d-4            [-1, 3, 416, 416]
            Upsampling-1
            Softmax
```